...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void no_subscription_no_gains() {
        ...
        temperatureFlux.doOnSubscribe(event -> hooksTriggered.add("subscribe"))
                .subscribe();
    ...
    public void be_there_early() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service();
        temperatureFlux.doFirst(() -> hooksTriggered.add("before subscribe"))
                .subscribe();
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service();
        temperatureFlux.doOnEach(signal -> {
    ...
    public void need_to_cancel() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service();
        temperatureFlux.doOnCancel(() -> canceled.set(true))
                .subscribe()
                .dispose();
    ...
    public void terminator() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doOnTerminate(hooksTriggeredCounter::incrementAndGet); // subscribe()로 했을 때랑 다른 것이 무엇인가..?
    ...
    public void one_to_catch_them_all() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doFinally(signal -> hooksTriggeredCounter.incrementAndGet());
    ...
    public void ordering_is_important() {
        ...
        Mono<Boolean> just = Mono.just(true)
                ...
                .doFirst(() -> sideEffects.add("one")); //이게뭐징...
